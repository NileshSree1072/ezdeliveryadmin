        ...
        <form onSubmit={saveProduct}>
            ...
            {propertiesToFill.length>0 && propertiesToFill.map(p=>(
                <div className="">
                    ...
                    <div><select value={productProperties[p.name]} 
                    onChange={ev=> 
            ...
            <div className="mb-2v flex flex-wrap gap-1">
                <ReactSortable
                    list={images}
                ...
                flex items-center justify-center text-sm gap-1 flex flex-col
                text-primary rounded-sm bg-gray-200 bg-white shadow-sm border border-primary">
